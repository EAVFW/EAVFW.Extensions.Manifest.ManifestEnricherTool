...
namespace EAVFW.Extensions.Manifest.SDK
{
    ...
    public class ManifestPermissionGenerator : IManifestPermissionGenerator
    {
        ...
        public async Task<string> CreateInitializationScript(JToken model, string systemUserEntity)
        {
            ...
            sb.AppendLine($"INSERT INTO [{parameterGenerator.GetParameter("DBName")}].[{parameterGenerator.GetParameter("DBSchema")}].[Identities] (Id, Name,ModifiedOn,CreatedOn,CreatedById,ModifiedById,OwnerId) VALUES ('$(UserGuid)', '$(UserName)', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'{adminSGId}','{adminSGId}','{adminSGId}')");
